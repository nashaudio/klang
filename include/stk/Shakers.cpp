...
const StkFloat CRUNCH1_RADII[CRUNCH1_RESONANCES] = { 0.95f };
const StkFloat CRUNCH1_GAINS[CRUNCH1_RESONANCES] = { 1.0f };

// Nextmug + Coins
const StkFloat NEXTMUG_SOUND_DECAY = 0.97f;
const StkFloat NEXTMUG_SYSTEM_DECAY = 0.9995f;
const StkFloat NEXTMUG_GAIN = 0.8f;
